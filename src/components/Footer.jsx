...
const Footer = () => {
  return (
    ...
    >
      ...
      >
        <div className="w-full md:w-1/3 mb-8 md:mb-0">
          ...
          <p className="text-gray-400 mt-4">
            ...
            magnam amet pariatur vitae incidunt. Neque sequi ad, fugit officia
            non nemo, accusantium doloribus eum laudantium eaque error aperiam.
            Commodi!
          </p>
        </div>
      ...
      <div className="mt-4 border-t border-gray-700 py-4 text-gray-400 text-center">
        Copyright 2025 @ Kazi Badrul. All Right Reserved.
      </div>
    </div>
  );
};
